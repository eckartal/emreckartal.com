export const metadata = {
  ...
  openGraph: {
    title: 'Founding marketing for busy folks',
    description: 'Marketing is creating an in some people\'s mind, in cool statements. It starts with positioning, continue with messaging and ends up with shaping the sales narrative, social sharings and so on so forth. This kind of descriptions are a bit vague and marketers love to use some fancy words to make things sound cool and complicated like how engineers do. The most critical aspect is to explain the concepts as concise and clear as possible. I\'m trying to do this for marketing in this post.',
    date: '2025-03-03',
