export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://emreckartal.com/2025/marketing',
    type: 'article'
  },
  alternates: {
    canonical: 'https://emreckartal.com/2025/marketing'
  }
}
...
export default function Page({ children }) {
  return (
    <article className="prose dark:prose-invert">
      <h1 className="text-3xl font-bold mb-4">Founding Marketing for Busy Folks: Simplified Strategies</h1>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BlogPosting',
            'headline': 'Founding Marketing for Busy Folks: Simplified Strategies',
            'description': 'Marketing is creating an impression in some people\'s minds through clear statements. Discover simplified marketing strategies for busy founders.',
            'image': 'https://emreckartal.com/images/marketing-101',
            'datePublished': '2025-03-03',
            'dateModified': '2025-03-03',
            'author': {
              '@type': 'Person',
              'name': 'Emre Can Kartal',
            ...
            'publisher': {
              ...
              'logo': {
                '@type': 'ImageObject',
                'url': 'https://emreckartal.com/images/eckartal-profile.jpg'
              }
            },
            'mainEntityOfPage': {
              '@type': 'WebPage',
              '@id': 'https://emreckartal.com/2025/marketing'
            }
          })
        }}
      />
