...
export default function Page({ children }) {
  return (
    <article className="prose dark:prose-invert">
      <h1 className="text-3xl font-bold mb-4">Founding marketing for busy founders</h1>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'BlogPosting',
            'headline': 'Founding marketing for busy founders',
            'description': 'Marketing is creating an impression in some people\'s minds through clear statements.',
